/**
 * Create Post Modal (legacy)
 * Currently disabled - using dedicated create view.
 * Can be re-enabled by setting ENABLE_CREATE_POST_MODAL = true
 */

import { showModal } from './modal.js'

const ENABLE_CREATE_POST_MODAL = false;
// Add Post Modal
if (ENABLE_CREATE_POST_MODAL) {
